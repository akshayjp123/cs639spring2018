    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                switch (view.getId()){
                    ...
                    case R.id.delete_fact_button:
                        ...
                        if(item1.deleteFact()) Toast.makeText(getBaseContext(), R.string.item_deleted,Toast.LENGTH_SHORT).show();
                        else Toast.makeText(getBaseContext(), R.string.delete_fails, Toast.LENGTH_SHORT).show();
                }
        ...
        addFact.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(newFact))Toast.makeText(getBaseContext(), R.string.enter_fact, Toast.LENGTH_SHORT).show();
                //Check if animal is selected
                else if (mPos== -1) Toast.makeText(getBaseContext(), R.string.select_animal, Toast.LENGTH_SHORT).show();
                else {
